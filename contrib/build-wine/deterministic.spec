...
datas = [
    ...
    (home+'electroncash/servers_gs.json', 'electroncash'),
    (home+'electroncash/servers_gs_testnet.json', 'electroncash'),
    (home+'electroncash/servers_post_office.json', 'electroncash'),
    (home+'electroncash/servers_post_office_testnet.json', 'electroncash'),
